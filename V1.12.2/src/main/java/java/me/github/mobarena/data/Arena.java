...
import java.me.github.mobarena.Util.StringData;
import java.me.github.mobarena.Util.Translate;
import java.me.github.mobarena.hook.MythicMobs;
import java.me.github.mobarena.runnable.Delay;
    ...
    public void Create() {
        try {
            ...
            if (MobArena.WorldEdit.getSession(player) != null) {
                MobArena.WorldEdit.getSession(player).getSelection(world).getMaximumPoint();

                Area area = Data.getArena(player);
    ...
    public void setRegion() {
        if (MobArena.WorldEdit.getSession(player) != null) {
            try {
                ...
                BlockVector pos1 = MobArena.WorldEdit.getSession(player).getSelection().getBoundingBox().getPos1();
                BlockVector pos2 = MobArena.WorldEdit.getSession(player).getSelection().getBoundingBox().getPos2();
